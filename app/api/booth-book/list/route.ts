...
/**
 * Lists every take stored in the private `booth-book` bucket and hands back a signed
 * playback URL for each, so the /sarahbook booth can rewatch clips (including ones
