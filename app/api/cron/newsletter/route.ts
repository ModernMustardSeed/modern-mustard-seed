...
<html><body style="font-family:Arial,sans-serif;line-height:1.65;color:#333;max-width:600px;margin:0 auto;padding:20px">
  <p style="font-size:11px;letter-spacing:3px;color:#FF8E72;text-transform:uppercase;font-weight:700">
  ...
  <p style="margin:24px 0">
    <a href="${playbookUrl}" style="display:inline-block;padding:14px 28px;background:linear-gradient(120deg,#FF6B6B,#FFB347);color:#ffffff;text-decoration:none;font-weight:700;border-radius:999px;font-size:12px;letter-spacing:2px;text-transform:uppercase">Read the playbook</a>
  </p>
  <p style="font-size:14px;color:#777">Free to read. Free to run yourself. The whole point.</p>
  <p style="font-size:14px;color:#777">If you would rather have us ship the thing for you, the <a href="https://modernmustardseed.com/build-queue" style="color:#FF8E72">Build Queue</a> is open. Four slots a quarter.</p>
