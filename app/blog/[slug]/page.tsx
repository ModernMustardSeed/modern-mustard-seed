      ...
      <article className="relative min-h-screen bg-[#FBF6EA] text-[#161616] pt-36 md:pt-44 pb-20">
        ...
        <div className="relative max-w-3xl mx-auto px-6 md:px-8">
          ...
          <section className="mt-14 pop-card-yellow p-7">
            ...
            <p className="mt-4 leading-relaxed"><Link href="/agentic-websites" className="underline font-bold">Explore our AI websites</Link>, <Link href="/work" className="underline font-bold">see the work</Link>, or <Link href="/book" className="underline font-bold">talk with Sarah</Link> about your business.</p>
