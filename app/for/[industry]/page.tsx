      ...
      <article className="relative pt-36 md:pt-44 pb-20">
        ...
        <header className="max-w-5xl mx-auto px-6 md:px-8 text-center mb-20">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              href="/audit"
              className="px-8 py-3.5 text-[11px] uppercase tracking-[0.2em] font-sans font-semibold text-white bg-gradient-to-r from-mustard-600 via-mustard-500 to-mustard-400 rounded-full shadow-[0_0_30px_rgba(78,205,196,0.2)] hover:shadow-[0_0_40px_rgba(78,205,196,0.35)] transition-all"
            >
        ...
        <section className="max-w-4xl mx-auto px-6 md:px-8 py-16">
          <div className="glass-card p-8 md:p-12 border-mustard-500/15">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Link
                href="/audit"
                className="px-6 py-3 text-[11px] uppercase tracking-[0.2em] font-sans font-semibold text-white bg-gradient-to-r from-mustard-600 via-mustard-500 to-mustard-400 rounded-full hover:shadow-[0_0_30px_rgba(78,205,196,0.25)] transition-all"
              >
                Free AI Audit
              </Link>
            </div>
        ...
        <section className="max-w-4xl mx-auto px-6 md:px-8 py-12 text-center">
          <div className="glass-card p-10 md:p-14 border-mustard-500/20">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                href="/audit"
                className="px-8 py-3.5 text-[11px] uppercase tracking-[0.2em] font-sans font-semibold text-white bg-gradient-to-r from-mustard-600 via-mustard-500 to-mustard-400 rounded-full shadow-[0_0_30px_rgba(78,205,196,0.25)] hover:shadow-[0_0_40px_rgba(78,205,196,0.45)] transition-all"
              >
                Run the Free AI Audit
              </Link>
              <Link
