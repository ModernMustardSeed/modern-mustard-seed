      ...
      <div className="relative pt-36 md:pt-44 pb-24">
        <div className="max-w-6xl mx-auto px-6 md:px-8">
          ...
          <div className="text-center">
            <Link
              href="/audit"
              className="inline-block px-8 py-3.5 text-[11px] uppercase tracking-[0.2em] font-sans font-semibold text-black bg-gradient-to-r from-mustard-500 to-mustard-400 rounded-full shadow-[0_0_30px_rgba(200,164,21,0.25)] hover:shadow-[0_0_40px_rgba(200,164,21,0.45)] transition-all"
            >
