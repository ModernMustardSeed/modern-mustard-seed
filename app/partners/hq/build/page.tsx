...
export const metadata = buildMetadata({ title: 'Build Under Your Flag', noindex: true });
export const dynamic = 'force-dynamic';

/**
 * The partner mint surface: an approved partner with build access queues a
 ...
 */
export default async function PartnerBuildPage() {
    ...
    <div className="min-h-screen bg-[#FBF6EA] text-[#161616]">
      <header className="halftone-bg border-b-2 border-[#161616]">
        <div className="max-w-3xl mx-auto px-6 pt-10 pb-10">
          ...
          <span className="block text-[10px] uppercase tracking-[0.4em] text-[#E0301E] font-mono font-bold mt-4">Build under your flag</span>
