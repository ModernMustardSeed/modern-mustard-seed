...
export const metadata = buildMetadata({
  ...
  description:
    'Become a Modern Mustard Seed partner. Earn 50% on every playbook and bundle, 25% every month on any business you put on a voice agent (for a year), and up to 20% on custom builds. Free access to everything, your own link, and a done-for-you playbook. Apply today.',
  path: '/partners',
});
...
const LADDER = [
  ...
  },
  {
    ...
    detail: 'Put a business on a 24/7 voice agent and earn a quarter of what they pay, every single month, for a full year. Refer ten and you have built yourself a monthly check that shows up whether you work or not.',
...
const DAY_ONE = [
  ...
  { t: 'Real earnings, real fast', d: 'Products pay the moment someone buys. The voice agent pays you monthly. Builds are the big ones. No cap on any of it.' },
];
      ...
      <section className="relative px-6 pt-36 pb-16 overflow-hidden halftone-bg">
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="mt-7 text-[#3A3733] text-lg font-body font-light max-w-2xl mx-auto leading-relaxed">
            Share our AI playbooks and earn 50% on every sale. Send a business to a 24/7 voice agent and earn 25% of their bill every month, for a year. Point a bigger client to a build and earn up to 20%. You bring the trust. We do the work and pay you well.
          </p>
