...
export const metadata = buildMetadata({
  ...
  description:
    'Ready-to-paste prompts for people who have never used Claude or ChatGPT. Pick your niche and get a full playbook customized to your business: emails, social posts, sales, and more. Free, with a branded PDF.',
  path: '/prompt-playbook',
});

const playbookFaq = [
  {
    q: 'What is the Prompt Playbook?',
    a: 'A free collection of ready-to-paste prompts for people who want to use chat tools like Claude or ChatGPT but have never actually done it. You pick your niche and every prompt is rewritten for your exact business, covering the emails you keep putting off, a week of social posts, proposals, summarizing long documents, and making decisions. Copy any prompt with one tap, or email yourself the whole thing as a branded PDF.',
  },
  {
    q: 'I have literally never used Claude or ChatGPT. Is this for me?',
    a: 'Yes, this is built exactly for you. These tools are just a chat box: you open claude.ai or chatgpt.com (both have a free version, no credit card), paste one of these prompts, and press enter. The playbook includes a two-minute primer on how it works and the four parts of a good prompt, so you can start today with zero experience.',
  },
  {
    q: 'Is it free, and which tool do I need?',
    a: 'The playbook is completely free, including the PDF. The prompts work in any major chat tool. Claude (claude.ai) and ChatGPT (chatgpt.com) both have a free tier that needs no credit card. Paste a prompt into either one and it works.',
  },
  {
  ...
  {
    q: 'Can Modern Mustard Seed build agentic systems into my business for me?',
    a: 'Yes. Prompts are the starting point. We build the voice and chat agents, the automations, and the systems that answer, book, and follow up for you around the clock, usually shipped in weeks, not months. Most people use the playbook to get comfortable with the models, then have us wire the real thing into their business.',
  },
];
...
const howToJsonLd = {
  ...
  '@type': 'HowTo',
  name: 'How to start using Claude or ChatGPT with ready-made prompts',
  description:
    'How a complete beginner can start using chat tools like Claude or ChatGPT with customized, ready-to-paste prompts.',
  totalTime: 'PT10M',
  step: [
    ...
    { '@type': 'HowToStep', position: 2, name: 'Open a free chat tool', text: 'Open claude.ai or chatgpt.com. Both have a free version with no credit card required.' },
      ...
      <JsonLd
        data={[
          breadcrumbJsonLd([
            ...
            { name: 'The Prompt Playbook', url: '/prompt-playbook' },
          ]),
      ...
      <div className="relative min-h-screen bg-[#FBF6EA] text-[#161616] pt-36 md:pt-44 pb-24">
        ...
        <div className="relative">
          ...
          <div className="px-6 md:px-8 mt-20">
            <NewsletterSignup
              headline="Get the agentic plays we use in real client builds."
