...
export default function ResourcesPage() {
  ...
  return <article className="bg-[#FBF6EA] text-[#161616] pt-28 md:pt-40 pb-20">
    ...
    <section className="max-w-5xl mx-auto px-6 mt-14"><div className="pop-card-yellow p-8"><h2 className="font-display text-3xl font-black">Bring it back to your business.</h2><p className="mt-4 leading-relaxed">The <Link href="/website-audit" className="underline font-bold">GEO Desk audit</Link> checks your current site. Our <Link href="/agentic-websites" className="underline font-bold">AI website guide</Link> explains the build. <Link href="/work" className="underline font-bold">The work</Link> gives you examples to inspect. We build from <Link href="/montana/kalispell" className="underline font-bold">Kalispell</Link> for <Link href="/montana" className="underline font-bold">Montana</Link> and clients nationwide.</p><div className="mt-6 flex flex-wrap gap-4"><Link href="/book" className="pop-card px-6 py-4 font-bold">Begin an Engagement</Link><Link href="/blog" className="pop-card px-6 py-4 font-bold">All Studio Writing</Link></div></div></section>
  </article>;
}
