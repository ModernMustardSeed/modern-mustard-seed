...
// The Voice Agent Build share card: the nameplate badge with the trainer.
export const runtime = 'nodejs';

export const alt = 'The Voice Agent Build. Hear your own voice agent answer live. Free, from Modern Mustard Seed.';
