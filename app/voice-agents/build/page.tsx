...
import BuildExperience from '@/components/sidekick/BuildExperience';
...
export const metadata = buildMetadata({
  ...
  image: '/voice-agents/build/opengraph-image',
  // PARKED 2026-08-12 (Sarah). The site already has /voice-agents and /demos, so
  // the build landing is unlisted from every nav, the sitemap, and llms.txt, and
  ...
  // here. The /build/demo/<runId> and /build/welcome subroutes are unaffected.
    ...
    '@graph': [
      ...
      },
      {
        ...
        step: [
          ...
          { '@type': 'HowToStep', name: 'Watch the build train your Voice Agent', text: 'Greeting drills, booking reps, composure tests, personalized to your business.' },
