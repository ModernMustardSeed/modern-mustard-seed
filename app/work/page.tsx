      ...
      <div className="relative pt-36 md:pt-44 pb-28">
        <div className="max-w-6xl mx-auto px-6 md:px-8">
          ...
          <div className="text-center glass-card p-10 max-w-3xl mx-auto">
            ...
            <Link
              href="/build-queue"
              className="inline-block px-8 py-3.5 text-[11px] uppercase tracking-[0.2em] font-sans font-bold text-white bg-gradient-to-r from-mustard-600 via-mustard-500 to-mustard-400 rounded-full hover:shadow-[0_0_30px_rgba(78,205,196,0.25)] transition-all"
            >
