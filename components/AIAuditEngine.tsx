...
const ImpactBar = ({ value, className = '' }: { value: number; className?: string }) => (
  <div className={`h-1.5 rounded-full bg-white/[0.04] ${className}`}>
    <div
      ...
      style={{ width: `${value}%`, background: `linear-gradient(90deg, ${M}, ${ML})`, boxShadow: `0 0 6px rgba(255,107,53,0.25)` }}
    />
  </div>
);
    ...
    <div className="min-h-screen bg-[#080c16] text-white font-body relative overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className="absolute inset-0 opacity-[0.025]"
          style={{ backgroundImage: 'radial-gradient(rgba(255,107,53,0.8) 1px, transparent 1px)', backgroundSize: '40px 40px' }} />
      ...
      <div className="relative z-10 max-w-screen-2xl mx-auto px-6 md:px-10 py-10">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 rounded-lg text-[11px] font-sans font-bold uppercase tracking-[0.15em] transition-all hover:scale-[1.02] text-[#080c16]"
              style={{ background: `linear-gradient(135deg, ${M}, ${ML})`, boxShadow: `0 3px 16px rgba(255,107,53,0.35)` }}
            >
                  ...
                  <div className="rounded-2xl p-6 text-center" style={{ background: MG, border: `1px solid ${MB}` }}>
                    ...
                    <div className="flex gap-3 justify-center flex-wrap">
                      <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer"
                        ...
                        style={{ background: `linear-gradient(135deg, ${M}, ${ML})`, boxShadow: `0 4px 20px rgba(255,107,53,0.25)` }}>
            ...
            return (
              <button key={k} onClick={() => switchInd(k)}
                ...
                style={{
                  ...
                  color: isA ? '#080c16' : 'rgba(255,255,255,0.45)',
        ...
        <div
          ...
          style={{
            background: `linear-gradient(135deg, rgba(255,107,53,0.12) 0%, rgba(10,8,4,0.5) 60%, rgba(255,107,53,0.06) 100%)`,
            border: `1px solid rgba(255,107,53,0.35)`,
            boxShadow: `0 0 40px rgba(255,107,53,0.08), inset 0 1px 0 rgba(255,107,53,0.15)`,
        ...
        <div className="flex gap-1 mb-5 overflow-x-auto pb-1">
          {TABS.map(t => (
            <button key={t.key} onClick={() => setTab(t.key)}
              ...
              style={{
                background: tab === t.key ? `rgba(255,107,53,0.18)` : 'transparent',
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
            ...
            <div className="glass-card p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-[9px] font-mono px-2 py-0.5 rounded" style={{ color: ML, background: `rgba(255,107,53,0.15)`, border: `1px solid rgba(255,107,53,0.25)` }}>✦ Critical</span>
              </div>
                ...
                return (
                  <div key={i} className="mb-3 rounded-xl p-3 transition-all"
                    ...
                    <div className="flex items-center gap-3 mb-2">
                      <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ background: `rgba(255,107,53,0.15)`, boxShadow: `0 0 12px rgba(255,107,53,0.15)` }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="glass-card p-6 flex flex-col justify-center">
              ...
              <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer"
                ...
                style={{ background: `linear-gradient(135deg, ${M}, ${ML})`, boxShadow: `0 4px 20px rgba(255,107,53,0.2)` }}>
        ...
        <div className="mt-8 rounded-2xl p-10 text-center relative overflow-hidden"
          style={{
            background: `linear-gradient(135deg, rgba(255,107,53,0.22) 0%, rgba(255,107,53,0.08) 50%, rgba(255,202,40,0.15) 100%)`,
            border: `1px solid rgba(255,107,53,0.45)`,
            boxShadow: `0 0 80px rgba(255,107,53,0.12), inset 0 1px 0 rgba(255,202,40,0.25), 0 1px 0 rgba(255,107,53,0.2)`,
          }}>
          ...
          <div className="relative">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-[9px] font-mono font-bold tracking-[0.3em] uppercase mb-4"
              style={{ background: 'rgba(255,107,53,0.2)', border: `1px solid rgba(255,107,53,0.4)`, color: ML }}>
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              <button onClick={() => setShowAudit(true)}
                className="flex items-center gap-2 px-8 py-4 rounded-xl text-sm font-sans font-bold text-[#080c16] transition-all hover:scale-[1.02]"
                style={{ background: `linear-gradient(135deg, ${M}, ${ML})`, boxShadow: `0 6px 30px rgba(255,107,53,0.40)` }}>
