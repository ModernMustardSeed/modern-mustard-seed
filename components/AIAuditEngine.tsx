...
const ScoreRing = ({ score, size = 88 }: { score: number; size?: number }) => {
  ...
  return (
    ...
    >
      <div
        className="rounded-full bg-[#1A1140] flex items-center justify-center"
...
const AIAuditEngine: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#1A1140] text-white font-body relative overflow-x-hidden">
      {/* Ambient background */}
            ...
            return (
              <button key={k} onClick={() => switchInd(k)}
                ...
                style={{
                  ...
                  color: isA ? '#1A1140' : 'rgba(255,255,255,0.45)',
