      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 max-w-6xl mx-auto">
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={sending}
                className="w-full py-3.5 text-[11px] uppercase tracking-[0.2em] font-sans font-bold text-white bg-gradient-to-r from-mustard-600 via-mustard-500 to-mustard-400 rounded-lg hover:shadow-[0_0_30px_rgba(255,179,71,0.2)] transition-all duration-300 disabled:opacity-50"
              >
        ...
        <div className="space-y-8">
          <div className="glass-card p-8">
            <span className="text-[9px] uppercase tracking-[0.3em] text-white/20 font-mono font-bold block mb-4">
              Book a Call
            </span>
