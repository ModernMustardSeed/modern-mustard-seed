    ...
    >
      ...
      <div className="max-w-5xl mx-auto text-center relative">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
          <MagneticLink
            href="/build-queue"
            className="px-10 py-4 text-[12px] uppercase tracking-[0.22em] font-sans font-bold text-white bg-gradient-to-r from-mustard-600 via-mustard-500 to-mustard-400 rounded-full hover:shadow-[0_0_55px_rgba(78,205,196,0.5)]"
          >
