  ...
  return (
    <footer className="relative w-full px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-10 bg-[#080c16] border-t border-cream-100/[0.04]">
      ...
      <div className="text-center max-w-2xl mx-auto mb-16">
        <p className="font-sans font-semibold text-lg md:text-xl text-mustard-200/80 leading-relaxed mb-4">
        ...
        <cite className="text-[10px] uppercase tracking-[0.4em] text-mustard-200/80 font-mono font-bold not-italic">
          Matthew 13:31-32
        </cite>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-8 max-w-6xl mx-auto mb-12 pb-12 border-b border-white/[0.04]">
        ...
        {linkSections.map((section) => (
          <div key={section.title}>
            <span className="text-[10px] uppercase tracking-[0.3em] text-mustard-200/80 font-mono font-bold block mb-4">
              {section.title}
            </span>
            <ul className="space-y-2">
              {section.links.map((l) => (
                <li key={l.label}>
                  <Link
                    href={l.href}
                    className="text-sm text-white/65 hover:text-mustard-400 transition-colors font-body"
                  >
                    {l.label}
                  </Link>
                </li>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <p className="text-[10px] text-white/55 font-mono tracking-wider">
