    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-36 md:pt-44 text-center">
      <div className="mb-6 opacity-0 animate-fade-in-up">
        ...
        <h1 className="font-sans text-4xl md:text-7xl lg:text-8xl font-semibold tracking-tight uppercase leading-[0.95]">
          ...
          <br />
          <span className="text-liquid-metal text-5xl md:text-8xl lg:text-9xl font-black tracking-wider drop-shadow-[0_0_40px_rgba(255,255,255,0.15)]">
            Seed
          </span>
        </h1>
      </div>
      ...
      <div className="max-w-lg opacity-0 animate-fade-in-up-delay-2">
        <div className="glass-card px-6 py-5 md:px-8 md:py-6">
          <span className="text-[9px] md:text-[10px] text-mustard-500/70 font-bold tracking-[0.4em] uppercase font-mono drop-shadow-[0_0_6px_rgba(255,107,53,0.3)] block mb-2">
            Matthew 17:20
          </span>
          <p className="text-white/60 font-sans font-semibold text-sm md:text-base tracking-wide leading-relaxed">
            &ldquo;If you have faith as small as a mustard seed&hellip;{' '}
            <span className="text-gradient-mustard">Nothing will be impossible for you.</span>&rdquo;
          </p>
        </div>
      </div>
