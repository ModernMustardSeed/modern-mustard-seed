...
export default function HeroIdeaToProduct() {
  return (
    <section className="relative isolate min-h-[92vh] flex flex-col items-center justify-center px-6 pt-36 md:pt-44 pb-24 text-center overflow-hidden">
      ...
      <div
        className="absolute inset-0 z-[1] bg-[radial-gradient(ellipse_at_top_right,rgba(255,107,53,0.18)_0%,transparent_45%),radial-gradient(ellipse_at_bottom_left,rgba(79,146,216,0.18)_0%,transparent_50%),radial-gradient(ellipse_at_top_left,rgba(111,172,231,0.12)_0%,transparent_55%)] mix-blend-screen pointer-events-none"
        aria-hidden="true"
      />

      {/* Layer 4: Center vignette focuses the eye */}
      <div
        className="absolute inset-0 z-[1] bg-[radial-gradient(ellipse_at_center,transparent_0%,transparent_28%,rgba(8,12,22,0.72)_85%,rgba(8,12,22,0.92)_100%)] pointer-events-none"
        aria-hidden="true"
      />

      {/* Layer 5: Bottom fade into next section */}
      <div
        className="absolute inset-x-0 bottom-0 h-1/3 z-[1] bg-gradient-to-b from-transparent via-[#080c16]/70 to-[#080c16] pointer-events-none"
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="opacity-0 animate-fade-in-up inline-flex items-center gap-2.5 px-4 py-1.5 mb-10 rounded-full border border-sky-400/45 bg-night-900/40 backdrop-blur-md shadow-[0_0_30px_rgba(255,107,53,0.12)]">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center opacity-0 animate-fade-in-up-delay-3">
          <MagneticLink
            href="/build-queue"
            className="px-8 py-3.5 text-[11px] uppercase tracking-[0.2em] font-sans font-semibold text-white bg-sunrise-warm rounded-full shadow-[0_0_40px_rgba(255,107,53,0.4)] hover:shadow-[0_0_50px_rgba(255,107,53,0.55)]"
          >
