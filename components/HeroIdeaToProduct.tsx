...
export default function HeroIdeaToProduct() {
  return (
    <section className="relative isolate min-h-[94vh] flex flex-col items-center justify-center px-6 pt-36 md:pt-44 pb-24 text-center overflow-hidden">
      ...
      <div
        className="absolute inset-0 z-[1] bg-[#1F4280]/35 mix-blend-multiply pointer-events-none"
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <span className="opacity-0 animate-fade-in-up text-[10px] tracking-[0.4em] uppercase text-cream-100/80 font-mono font-medium block mb-10">
          Modern Mustard Seed
        </span>
