    ...
    return (
      <form onSubmit={subscribe} className="flex flex-col sm:flex-row gap-3 max-w-lg">
        ...
        <button
          ...
          className="px-6 py-3 text-[11px] uppercase tracking-[0.2em] font-sans font-bold text-black bg-gradient-to-r from-mustard-500 to-mustard-400 rounded-lg hover:shadow-[0_0_30px_rgba(200,164,21,0.2)] transition-all disabled:opacity-50"
        >
