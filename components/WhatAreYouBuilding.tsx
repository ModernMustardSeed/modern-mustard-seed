            ...
            return (
              <button
                ...
                className={`group inline-flex items-center gap-2.5 px-5 py-3 rounded-full text-[11px] md:text-[12px] uppercase tracking-[0.18em] font-sans font-semibold transition-all duration-300 ${
                  isSelected
                    ? 'bg-gradient-to-r from-mustard-600 via-mustard-500 to-mustard-400 text-white border border-mustard-500 shadow-[0_0_30px_rgba(78,205,196,0.4)] scale-[1.02]'
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link
                ...
                className="flex-1 text-center px-8 py-3.5 text-[11px] uppercase tracking-[0.22em] font-sans font-bold text-white bg-gradient-to-r from-mustard-600 via-mustard-500 to-mustard-400 rounded-full hover:shadow-[0_0_40px_rgba(78,205,196,0.4)] transition-all"
              >
