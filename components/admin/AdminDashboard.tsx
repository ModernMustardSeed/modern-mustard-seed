...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0804] text-white">
      <header className="border-b border-white/[0.06] sticky top-0 z-30 bg-[#0a0804]/90 backdrop-blur-md">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex flex-wrap gap-3 mb-6 items-end">
          ...
          <button
            onClick={load}
            className="px-5 py-2.5 text-[11px] uppercase tracking-[0.2em] font-sans font-semibold text-black bg-gradient-to-r from-mustard-500 to-mustard-400 rounded-lg hover:shadow-[0_0_20px_rgba(200,164,21,0.2)] transition-all"
          >
            Apply
          </button>
        </div>
