...
const GROUPS: { name: string; items: Item[] }[] = [
  ...
  },
  {
    name: 'Marketing',
    items: [
      { key: 'mailer', label: 'The Mailer', href: '/admin/mailer' },
