...
const SK_CHECKLIST = [
  ...
  { id: 'capwatch', label: 'The free build is capped at 20 demos/day globally. If ads fill the cap (email alert fires), raise GLOBAL_DAILY_CAP in app/api/sidekick/build/route.ts before scaling spend.' },
  { id: 'review', label: 'Day 5-7: judge on cost per built demo (leads tagged source sidekick-build in the admin). The truth metric: Keep Him subscriptions, which email you on every sale, and booked calls from demo transcripts.' },
];
...
Tell us about your business (it takes about 60 seconds) and we build your demos first: a real working website and a voice agent that answers actual calls. Built for you, with your name on them, free.
...
Modern Mustard Seed builds your demos before you pay anything: your website, and your voice agent answering a real call. Sixty seconds to tell us about your business. The demos are on us.

See them working. Then make it real.`;

const UNV_HEADLINE = 'We build yours first. Free.';
const UNV_DESCRIPTION = 'A real website and a voice agent, built for your business before you pay.';
...
Tell us about your business (60 seconds, that is the whole form) and we build your demos first: a real working website and a voice agent that answers actual calls. Your name on both. Free to see working.
...
We build your demos FIRST. A real website. A voice agent that answers actual calls. Both with your name on them.
...
const UNV_IG_STORY = `We built something for you. No, really. For you. 🥂 Sixty seconds → your website and your voice agent. Working demos, free. Sticker link → modernmustardseed.com/demos`;
...
Tell us about your restaurant (60 seconds, that is the whole form) and we build your demos first: a website that makes people hungry, and an AI host that answers every call and books every table even during the dinner rush. Your restaurant's name on both. Free to see working.
...
Every missed call is a four-top eating somewhere else right now. So before you pay us anything, we build your fix and let you taste it: your website, and your AI host answering a real call for YOUR restaurant.
...
const UR_DESCRIPTION = 'A website and an AI host, built for your restaurant before you pay.';
...
Tell us about your roofing company (60 seconds, that is the whole form) and we build your demos first: a website that wins the click before your competitor's does, and a voice agent that catches every call while your hands are full of shingles. Your company's name on both. Free to see working.
...
Whoever picks up first usually wins the job. So we built the fix, and we will build YOURS free before you pay a cent: your website, and your voice agent answering a real call.
...
const UF_DESCRIPTION = 'A website and a voice agent, built for your roofing company before you pay.';
...
There is a better way to fly. Tell us about your business (sixty seconds, that is the whole form) and we build your demos first: a website worth putting on the big screen, and a voice agent that answers every hail, day, night, or warp speed.
...
Modern Mustard Seed builds yours: a website that sells while you sleep, and a voice agent that never leaves its post. We build both for your business first, free, and you see them working before any money changes hands.

Take the bridge. It takes sixty seconds.`;

const BR_HEADLINE = 'Take the bridge of your business.';
const BR_DESCRIPTION = 'A website and a voice agent. Built free first, for any business.';
...
Tell us about your business (sixty seconds, that is the whole form) and we build your demos first: a website that sells while you sleep, and a voice agent that answers every call, day or night.
...
Modern Mustard Seed builds you two things and builds them before you pay anything: the website, and the voice agent that never misses a call.

One little seed, and the whole thing rebuilds itself. Sixty seconds to start.`;

const ST_HEADLINE = 'The stone age is over.';
const ST_DESCRIPTION = 'A website and a voice agent. Built free first, for any business.';
...
Your website and your voice agent. We build both before you pay a cent, then you decide.
...
const AM_LANDING = 'https://modernmustardseed.com/demos?utm_source=meta&utm_medium=paid&utm_campaign=answermachine';

const AM_COPY_A = `Every small business owner tells us the same three things.

I miss calls. Nobody can find me online. I am doing paperwork at midnight.

So we stopped handing out advice about it and built the machine that answers all three.

A website that sells while you sleep. An AI receptionist that answers every call, day or night.

Tell us about your business (sixty seconds, that is the entire form) and we build all three of yours first. Real, working, and yours to look at before you pay anything.

You do not need advice. You need the answer.`;

const AM_COPY_B = `Name the last three problems that cost you money this month.

Odds are it was a call you never got to, a customer who could not find you, and an evening you spent on paperwork instead of with your family.

Every consultant in the world will tell you that. None of them will fix it.

We build the fix and hand it to you first: your website and your AI receptionist, both built for your actual business before you pay a cent.

Sixty seconds to start. Then you decide.`;

const AM_HEADLINE = 'You don’t need advice. You need the answer.';
const AM_DESCRIPTION = 'A website and an AI receptionist. Both built free before you pay.';

const AM_CUTS = [
  { file: '/ads/answer-machine-4x5.mp4', label: '4:5 — Feed', note: 'Facebook + Instagram feed. The workhorse placement.' },
  { file: '/ads/answer-machine-9x16.mp4', label: '9:16 — Reels + Stories', note: 'Full-screen vertical. Doubles as an IG Reel + YouTube Short.' },
  { file: '/ads/answer-machine-16x9.mp4', label: '16:9 — In-stream + Google', note: 'Video feeds, YouTube / Google video, and the demos page hero.' },
  { file: '/ads/answer-machine-short-9x16.mp4', label: '9:16 — Short cut (~:20)', note: 'Cold-opens on the machine delivering, and on the phone answering itself.' },
];
...
const AM_CHECKLIST = [
  ...
  { id: 'captions', label: 'Decline Meta auto-captions (styled caption pills are already burned in).' },
  { id: 'honest', label: 'COPY LAW: the DEMOS are free, going live is setup + monthly from day one. Never write "free trial" in any edit.' },
  { id: 'hook', label: 'The signature beat is at ~0:17, where the machine delivers and the telephone answers itself out loud in its own voice. If hold-rate dies before then, swap to the SHORT cut (it cold-opens on exactly that beat) as the primary creative.' },
  { id: 'audience', label: 'Audience: Advantage+, broad small-business. The three problems in beat one are the targeting: anyone who nods at "I miss calls" is the buyer. Resist interest-stacking on the first cell.' },
  { id: 'google', label: 'Google (optional, the reason for the 16:9 cut): run it as a YouTube / Demand Gen video ad. Same /demos landing, swap the link to utm_source=google.' },
  { id: 'organic', label: 'Organic: post the 9:16 as a Reel + YouTube Short and the 4:5 to FB the same day. Drafts are in the Organic launch posts section below (Sarah approves every post).' },
...
1. I miss calls.
2. Nobody can find me online.
3. I am doing paperwork at midnight.

So we stopped handing out advice about it and built the machine that answers all three:

A website that sells while you sleep. An AI receptionist that answers every call, day or night.

Here is the part people do not believe: we build all three for your business before you pay us anything. Telling us about your business takes about sixty seconds.

You do not need advice. You need the answer → modernmustardseed.com/demos`;

const AM_POST_IG = `The same three problems. Every single time.

Missed calls. Invisible online. Paperwork at midnight.

So we built the machine that answers them. Yours gets built free first, and it takes about sixty seconds to start.

Link in bio.

#smallbusiness #businessowner #aiforbusiness #automation #modernmustardseed`;
...
The same crew that built that page builds websites that talk and voice agents that answer every call.
...
Why show you that? Because it is the exact same build we do for businesses like yours: a website that talks and a voice agent that answers.
...
const SR_DESCRIPTION = 'A website that talks and a voice agent that answers. See the drive.';
...
That is what we do for a living: websites that talk and voice agents that answer every call.
...
const CH_COPY_A = `You thought a personal assistant was expensive.

A human chief of staff runs $52,000 to $96,000 a year, and works one shift.

Meet The Chief: a personal AI assistant who works every hour, never forgets, and starts at $597 a month. He runs your calendar, drafts and sends your email, makes your calls, researches anything, drills your sales pitch, builds your lead list, and wakes you with a verse and your plan for the day.

Call, text, or type to him any hour. He already knows your business.

Hear him yourself, or hire him today: modernmustardseed.com/chief`;

const CH_COPY_B = `You did not start a business to spend your life on the phone, in the inbox, and buried in your calendar.

The Chief takes all of it. He is a personal AI chief of staff, on call day and night: your calls made, your calendar run, your email drafted, your leads chased, your pitch drilled, and your morning briefing waiting with the Word.

A human assistant costs a fortune. The Chief starts at $597 a month, and you can hear him before you pay a cent.

Stop doing it all yourself: modernmustardseed.com/chief`;

const CH_HEADLINE = 'Meet The Chief.';
const CH_DESCRIPTION = 'A personal AI chief of staff. Calls, calendar, email, research, and coaching. From $597/mo.';

const CH_CUTS = [
  { file: '/ads/chief-4x5.mp4', label: '4:5 — Feed', note: 'Facebook + Instagram feed. The workhorse placement.' },
  { file: '/ads/chief-9x16.mp4', label: '9:16 — Reels + Stories', note: 'Full-screen vertical. Doubles as an IG Reel + YouTube Short.' },
  { file: '/ads/chief-16x9.mp4', label: '16:9 — In-stream + Google', note: 'Video feeds, YouTube / Google video, and the /chief page.' },
];

const CH_CHECKLIST = [
  { id: 'cell', label: 'Cell A (Meta): objective Traffic (switch to Conversions once the pixel is live). Budget $15/day. Learn More button → the /chief UTM link above. Paste Copy Variant 1 (you thought an assistant was expensive).' },
  { id: 'landing', label: 'This is a PRODUCT-offer funnel, not the demo funnel: it points at /chief and the goal is a hired Chief. Buyers land in the Pipeline under source=chief-buyer with a [bought:chief:*] note.' },
  { id: 'placements', label: 'Upload the 4:5 cut, then customize per placement: 9:16 for Reels/Stories, 16:9 for in-stream. The spot has spoken dialogue AND burned-in captions.' },
  { id: 'captions', label: 'Decline Meta auto-captions (styled caption pills are already burned in).' },
  { id: 'honest', label: 'COPY LAW: never write "free trial". The free thing is calling and hearing him at (406) 312-1223. Hiring him is setup + monthly from day one.' },
  { id: 'phone', label: 'The phone number IS a CTA: (406) 312-1223 lets a prospect hear him before they click. Worth a Call-objective ad variant using the number directly.' },
  { id: 'hook', label: 'First 3 seconds are the whole game: "Meet The Chief" + the mascot lands immediately. If hold-rate dies, test a cold-open on the cost bar (you thought an assistant was expensive).' },
  { id: 'audience', label: 'Audience: Advantage+, broad small-business owners, solopreneurs, and operators. The cost-of-an-assistant angle self-selects the overwhelmed founder.' },
  { id: 'google', label: 'Google (optional, the reason for the 16:9 cut): run it as a YouTube / Demand Gen video ad. Same /chief landing, swap the link to utm_source=google.' },
  { id: 'organic', label: 'Organic: post the 9:16 as a Reel + YouTube Short and the 4:5 to FB the same day. Drafts are in the Organic launch posts section below (Sarah approves every post).' },
  { id: 'abtest', label: 'Day 3: duplicate the ad with Copy Variant 2 (stop doing it all yourself) and let them fight. Kill the loser at day 6.' },
  { id: 'review', label: 'Day 5-7: judge on cost per hired Chief. Leads land in the Pipeline (source=chief-buyer); recurring revenue hits Orders on every invoice.' },
];

const CH_POST_FB = `You thought a personal assistant was expensive.

A human chief of staff runs $52,000 to $96,000 a year and works one shift. Meet The Chief: a personal AI assistant who works every hour and starts at $597 a month.

He runs your calendar, drafts your email, makes your calls, researches anything, drills your sales pitch, and wakes you with a verse and your plan for the day. Call, text, or type any hour.

Hear him yourself, or hire him today: modernmustardseed.com/chief`;

const CH_POST_IG = `Meet The Chief. Your personal AI chief of staff, on call day and night.

He runs your calendar, your inbox, and your calls, preps your pitch, and wakes you with the Word. From $597/mo, a fraction of a human assistant. Link in bio.

#aiforbusiness #smallbusiness #entrepreneur #productivity #modernmustardseed`;

const CH_POST_STORY = 'Meet The Chief. Your AI chief of staff, from $597/mo → modernmustardseed.com/chief';
...
export default function AdsPlaybook() {
  ...
  useEffect(() => {
    try {
      ...
      const rawChief = localStorage.getItem('mms-ads-checklist-chief');
    ...
    <div className="min-h-screen bg-[#FBF6EA] text-[#161616]">
      ...
      <main className="max-w-7xl mx-auto px-5 md:px-6 py-8 space-y-10">
        ...
        <section className="bg-white border-2 border-[#161616] shadow-[6px_6px_0_0_#161616] p-6 md:p-8">
          ...
          <div className="flex flex-wrap gap-3 mt-5">
            <a href="https://adsmanager.facebook.com" target="_blank" rel="noopener noreferrer" className="text-[12px] uppercase tracking-[0.18em] font-sans font-bold text-[#161616] px-4 py-2.5 border-2 border-[#161616] bg-[#F5B700] shadow-[3px_3px_0_0_#161616] hover:-translate-y-0.5 transition-transform">Open Ads Manager</a>
            <Link href="/audit" className="text-[12px] uppercase tracking-[0.18em] font-sans font-bold text-[#161616] px-4 py-2.5 border-2 border-[#161616] bg-white shadow-[3px_3px_0_0_#161616] hover:-translate-y-0.5 transition-transform">The audit funnel (landing)</Link>
          </div>
        </section>
        ...
        <section className="bg-[#080C16] border-2 border-[#161616] shadow-[6px_6px_0_0_#F5B700] p-6 md:p-8 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <div className="flex flex-wrap gap-3 mt-5">
              <a href="https://adsmanager.facebook.com" target="_blank" rel="noopener noreferrer" className="text-[12px] uppercase tracking-[0.18em] font-sans font-bold px-4 py-2.5 border-2 border-[#161616] bg-[#F5B700] shadow-[3px_3px_0_0_#FFDD55] hover:-translate-y-0.5 transition-transform text-[#161616]">Open Ads Manager</a>
              <Link href="/playbooks/fable-mind" className="text-[12px] uppercase tracking-[0.18em] font-sans font-bold px-4 py-2.5 border-2 border-[#161616] bg-white shadow-[3px_3px_0_0_#FFDD55] hover:-translate-y-0.5 transition-transform text-[#161616]">The playbook (landing)</Link>
        ...
        <section className="bg-[#080C16] border-2 border-[#161616] shadow-[6px_6px_0_0_#F5B700] p-6 md:p-8 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <div className="flex flex-wrap gap-3 mt-5">
              <a href="https://adsmanager.facebook.com" target="_blank" rel="noopener noreferrer" className="text-[12px] uppercase tracking-[0.18em] font-sans font-bold px-4 py-2.5 border-2 border-[#161616] bg-[#F5B700] shadow-[3px_3px_0_0_#FFDD55] hover:-translate-y-0.5 transition-transform text-[#161616]">Open Ads Manager</a>
              <Link href="/audit" className="text-[12px] uppercase tracking-[0.18em] font-sans font-bold px-4 py-2.5 border-2 border-[#161616] bg-white shadow-[3px_3px_0_0_#FFDD55] hover:-translate-y-0.5 transition-transform text-[#161616]">The audit funnel (landing)</Link>
        ...
        <section className="bg-[#080C16] border-2 border-[#161616] shadow-[6px_6px_0_0_#F5B700] p-6 md:p-8 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <div className="flex flex-wrap gap-3 mt-5">
              <a href="https://adsmanager.facebook.com" target="_blank" rel="noopener noreferrer" className="text-[12px] uppercase tracking-[0.18em] font-sans font-bold px-4 py-2.5 border-2 border-[#161616] bg-[#F5B700] shadow-[3px_3px_0_0_#FFDD55] hover:-translate-y-0.5 transition-transform text-[#161616]">Open Ads Manager</a>
              <Link href="/for/restaurants" className="text-[12px] uppercase tracking-[0.18em] font-sans font-bold px-4 py-2.5 border-2 border-[#161616] bg-white shadow-[3px_3px_0_0_#FFDD55] hover:-translate-y-0.5 transition-transform text-[#161616]">Restaurants page (landing)</Link>
              <Link href="/voice-agents" className="text-[12px] uppercase tracking-[0.18em] font-sans font-bold px-4 py-2.5 border-2 border-[#161616] bg-white shadow-[3px_3px_0_0_#FFDD55] hover:-translate-y-0.5 transition-transform text-[#161616]">Live demo (hear it)</Link>
            </div>
          </div>
        </section>
        ...
        <section className="bg-[#080C16] border-2 border-[#161616] shadow-[6px_6px_0_0_#F5B700] p-6 md:p-8 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-white/75 mt-3 max-w-3xl font-sans">
              ...
              dissolves into a bright sky city where the website floats and the voice agent answers every
              call. Universal gag, no franchise IP, and the transformation
        ...
        {tab === 'chief' && (<>
        {/* ============ Campaign seventeen: The Chief (personal AI chief of staff) ============ */}
        <section className="bg-[#161616] border-2 border-[#161616] shadow-[6px_6px_0_0_#F5B700] p-6 md:p-8 relative overflow-hidden">
          <div className="absolute inset-0 opacity-25" style={{ backgroundImage: 'radial-gradient(rgba(245,183,0,0.5) 1.5px, transparent 1.6px)', backgroundSize: '16px 16px' }} aria-hidden />
          <div className="relative">
            <span className="text-[10px] uppercase tracking-[0.3em] text-[#FFDD55] font-mono font-bold">Campaign seventeen · product offer, the chief of staff</span>
            <h2 className="font-display text-3xl md:text-4xl font-extrabold text-white mt-2">
              &ldquo;The Chief&rdquo; <span className="italic text-[#F5B700]">your right hand</span>
            </h2>
            <p className="text-white/75 mt-3 max-w-3xl font-sans">
              The cinematic spot for the flagship. Mr. Mustard, in his bowtie, is your personal chief of
              staff: he wakes you with a briefing, runs your calendar, drafts your email, makes your calls,
              and drills your pitch, all from a warm study. The anchor is the price, a human chief of staff
              costs a fortune and The Chief starts at $597 a month. One cell at $15/day into /chief. The free
              hook is the phone number, call and hear him at (406) 312-1223.
            </p>
            <div className="flex flex-wrap gap-3 mt-5">
              <a href="https://adsmanager.facebook.com" target="_blank" rel="noopener noreferrer" className="text-[12px] uppercase tracking-[0.18em] font-sans font-bold px-4 py-2.5 border-2 border-[#161616] bg-[#F5B700] shadow-[3px_3px_0_0_#FFDD55] hover:-translate-y-0.5 transition-transform text-[#161616]">Open Ads Manager</a>
              <a href="/chief" className="text-[12px] uppercase tracking-[0.18em] font-sans font-bold px-4 py-2.5 border-2 border-[#161616] bg-white shadow-[3px_3px_0_0_#FFDD55] hover:-translate-y-0.5 transition-transform text-[#161616]">The Chief (landing)</a>
              <a href="/admin/leads?source=chief-buyer" className="text-[12px] uppercase tracking-[0.18em] font-sans font-bold px-4 py-2.5 border-2 border-[#161616] bg-white shadow-[3px_3px_0_0_#FFDD55] hover:-translate-y-0.5 transition-transform text-[#161616]">Hired Chiefs (results)</a>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {CH_CUTS.map((c) => (
              <div key={c.file} className="bg-white border-2 border-[#161616] shadow-[4px_4px_0_0_#161616] p-4">
                <video controls preload="metadata" poster="/ads/chief-poster.png" className="w-full border border-[#161616] bg-black" src={c.file} />
                <div className="mt-3 flex items-center justify-between gap-2">
                  <div>
                    <p className="font-sans font-bold text-sm text-[#161616]">{c.label}</p>
                    <p className="text-xs text-[#161616]/60 font-sans">{c.note}</p>
        ...
        <section>
          <h3 className="font-display text-2xl font-extrabold text-[#161616] mb-5">Ad copy, ready to paste</h3>
          <div className="grid md:grid-cols-2 gap-5">
            <CopyBlock title="Primary text — Variant 1 (expensive assistant)" text={CH_COPY_A} />
            <CopyBlock title="Primary text — Variant 2 (stop doing it all)" text={CH_COPY_B} />
            <CopyBlock title="Headline" text={CH_HEADLINE} />
            <CopyBlock title="Description" text={CH_DESCRIPTION} />
            <CopyBlock title="Landing link with UTM (The Chief)" text={CH_LANDING} />
          </div>
        </section>
        ...
        <section>
          ...
          <p className="text-sm text-[#161616]/65 mb-5 font-sans">Same film, no spend. Post the 9:16 as a Reel and the 4:5 to Facebook the same day. Sarah approves every post before it goes out.</p>
          <div className="grid md:grid-cols-2 gap-5">
            <CopyBlock title="Facebook post (4:5 or 16:9 cut)" text={CH_POST_FB} />
            <CopyBlock title="Instagram Reel caption (9:16 cut)" text={CH_POST_IG} />
            <CopyBlock title="Instagram Story line (+ link sticker)" text={CH_POST_STORY} />
          </div>
        </section>
        ...
        <section className="bg-white border-2 border-[#161616] shadow-[6px_6px_0_0_#161616] p-6 md:p-8">
          <div className="flex items-center justify-between gap-3 mb-5">
            <h3 className="font-display text-2xl font-extrabold text-[#161616]">Launch checklist</h3>
            <span className="text-[11px] font-mono font-bold text-[#161616] bg-[#F5B700] border-2 border-[#161616] px-3 py-1 shadow-[2px_2px_0_0_#161616]">{doneCountChief}/{CH_CHECKLIST.length}</span>
          </div>
          <ol className="space-y-3">
            {CH_CHECKLIST.map((item, i) => (
              <li key={item.id}>
                <label className="flex items-start gap-3 cursor-pointer group">
                  <input
                    type="checkbox"
                    checked={!!checkedChief[item.id]}
                    onChange={() => toggleChief(item.id)}
                    className="mt-1 h-4 w-4 accent-[#F5B700] shrink-0"
                  />
                  <span className={`text-sm font-sans leading-relaxed ${checkedChief[item.id] ? 'text-[#161616]/40 line-through' : 'text-[#161616]/85'}`}>
                    <b className="font-mono text-[#E0301E] mr-1.5">{String(i + 1).padStart(2, '0')}</b>
                    {item.label}
                  </span>
                </label>
        ...
        {tab === 'ans' && (<>
        {/* ============ Campaign eighteen: The Answer Machine (worries in, answers out) ============ */}
        <section className="bg-[#2A1A0C] border-2 border-[#161616] shadow-[6px_6px_0_0_#F5B700] p-6 md:p-8 relative overflow-hidden">
          <div className="absolute inset-0 opacity-25" style={{ backgroundImage: 'radial-gradient(rgba(245,183,0,0.5) 1.5px, transparent 1.6px)', backgroundSize: '16px 16px' }} aria-hidden />
          <div className="relative">
            <span className="text-[10px] uppercase tracking-[0.3em] text-[#FFDD55] font-mono font-bold">Campaign eighteen &middot; demo funnel, the objection answered</span>
            <h2 className="font-display text-3xl md:text-4xl font-extrabold text-white mt-2">
              &ldquo;The Answer Machine&rdquo; <span className="italic text-[#F5B700]">worries in, answers out</span>
            </h2>
            <p className="text-white/75 mt-3 max-w-3xl font-sans">
              The spot that stops selling and starts answering. Mr. Mustard holds up a jar stuffed with the
              worries every owner hands him (missed calls, invisible online, paperwork at midnight), then the
              family tips the whole jar into a hand-built brass contraption and pulls the lever. What comes
              back up the golden beam is the product line: a telephone that answers itself out loud in its own
              voice, a little storefront that sells, and a panel that runs the business. It closes on an empty
              jar. The whole thesis in one image: you do not need advice, you need the answer, and we hand it
              to you built. One cell at $15/day into /demos.
            </p>
            <div className="flex flex-wrap gap-3 mt-5">
              <a href="https://adsmanager.facebook.com" target="_blank" rel="noopener noreferrer" className="text-[12px] uppercase tracking-[0.18em] font-sans font-bold px-4 py-2.5 border-2 border-[#161616] bg-[#F5B700] shadow-[3px_3px_0_0_#FFDD55] hover:-translate-y-0.5 transition-transform text-[#161616]">Open Ads Manager</a>
              <a href="/demos" className="text-[12px] uppercase tracking-[0.18em] font-sans font-bold px-4 py-2.5 border-2 border-[#161616] bg-white shadow-[3px_3px_0_0_#FFDD55] hover:-translate-y-0.5 transition-transform text-[#161616]">The Demo Station (landing)</a>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {AM_CUTS.map((c) => (
              <div key={c.file} className="bg-white border-2 border-[#161616] shadow-[4px_4px_0_0_#161616] p-4">
                <video controls preload="metadata" poster="/ads/answer-machine-poster.png" className="w-full border border-[#161616] bg-black" src={c.file} />
                <div className="mt-3 flex items-center justify-between gap-2">
                  <div>
                    <p className="font-sans font-bold text-sm text-[#161616]">{c.label}</p>
                    <p className="text-xs text-[#161616]/60 font-sans">{c.note}</p>
        ...
        <section>
          <h3 className="font-display text-2xl font-extrabold text-[#161616] mb-5">Ad copy, ready to paste</h3>
          <div className="grid md:grid-cols-2 gap-5">
            <CopyBlock title="Primary text &mdash; Variant 1 (the same three things)" text={AM_COPY_A} />
            <CopyBlock title="Primary text &mdash; Variant 2 (name the last three problems)" text={AM_COPY_B} />
            <CopyBlock title="Headline" text={AM_HEADLINE} />
            <CopyBlock title="Description" text={AM_DESCRIPTION} />
            <CopyBlock title="Landing link with UTM (the Demo Station)" text={AM_LANDING} />
          </div>
        </section>
        ...
        <section>
          ...
          <p className="text-sm text-[#161616]/65 mb-5 font-sans">Same film, no spend. Post the 9:16 as a Reel and the 4:5 to Facebook the same day. Sarah approves every post before it goes out.</p>
          <div className="grid md:grid-cols-2 gap-5">
            <CopyBlock title="Facebook post (4:5 or 16:9 cut)" text={AM_POST_FB} />
            <CopyBlock title="Instagram Reel caption (9:16 short cut)" text={AM_POST_IG} />
            <CopyBlock title="Instagram Story line (+ link sticker)" text={AM_POST_STORY} />
          </div>
        </section>
        ...
        <section className="bg-white border-2 border-[#161616] shadow-[6px_6px_0_0_#161616] p-6 md:p-8">
          <div className="flex items-center justify-between gap-3 mb-5">
            <h3 className="font-display text-2xl font-extrabold text-[#161616]">Launch checklist</h3>
            <span className="text-[11px] font-mono font-bold text-[#161616] bg-[#F5B700] border-2 border-[#161616] px-3 py-1 shadow-[2px_2px_0_0_#161616]">{doneCountAns}/{AM_CHECKLIST.length}</span>
          </div>
          <ol className="space-y-3">
            {AM_CHECKLIST.map((item, i) => (
              <li key={item.id}>
                <label className="flex items-start gap-3 cursor-pointer group">
                  <input
                    type="checkbox"
                    checked={!!checkedAns[item.id]}
                    onChange={() => toggleAns(item.id)}
                    className="mt-1 h-4 w-4 accent-[#F5B700] shrink-0"
                  />
        ...
        <section className="bg-[#0E3A4A] border-2 border-[#161616] shadow-[6px_6px_0_0_#F5B700] p-6 md:p-8 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <div className="flex flex-wrap gap-3 mt-5">
              <a href="https://adsmanager.facebook.com" target="_blank" rel="noopener noreferrer" className="text-[12px] uppercase tracking-[0.18em] font-sans font-bold px-4 py-2.5 border-2 border-[#161616] bg-[#F5B700] shadow-[3px_3px_0_0_#FFDD55] hover:-translate-y-0.5 transition-transform text-[#161616]">Open Ads Manager</a>
              <Link href="/" className="text-[12px] uppercase tracking-[0.18em] font-sans font-bold px-4 py-2.5 border-2 border-[#161616] bg-white shadow-[3px_3px_0_0_#FFDD55] hover:-translate-y-0.5 transition-transform text-[#161616]">The Journey (landing)</Link>
        ...
        <section className="bg-[#0B0E16] border-2 border-[#161616] shadow-[6px_6px_0_0_#F5B700] p-6 md:p-8 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <div className="flex flex-wrap gap-3 mt-5">
              <a href="https://adsmanager.facebook.com" target="_blank" rel="noopener noreferrer" className="text-[12px] uppercase tracking-[0.18em] font-sans font-bold px-4 py-2.5 border-2 border-[#161616] bg-[#F5B700] shadow-[3px_3px_0_0_#FFDD55] hover:-translate-y-0.5 transition-transform text-[#161616]">Open Ads Manager</a>
              <Link href="/voice-agents" className="text-[12px] uppercase tracking-[0.18em] font-sans font-bold px-4 py-2.5 border-2 border-[#161616] bg-white shadow-[3px_3px_0_0_#FFDD55] hover:-translate-y-0.5 transition-transform text-[#161616]">Voice Agents (landing)</Link>
        ...
        <section className="bg-[#161616] border-2 border-[#161616] shadow-[6px_6px_0_0_#F5B700] p-6 md:p-8 text-[#FBF6EA]">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-4 text-sm font-sans">
            ...
            <p><b className="text-[#F5B700]">Site:</b> paid traffic shows in GA4 + the first-party beacon under utm_campaign=callme, talkingwebsite, mustardmode, fablemind, sidekick, and goodnews. MUSTARD MODE free-plays, Fable Mind playbook emails, and built Voice Agent demos land in <a href="/admin/leads" className="underline decoration-[#F5B700]">Leads</a>, and purchases hit Orders with an email on every sale. Conversions get exact once the pixel vars are set.</p>
