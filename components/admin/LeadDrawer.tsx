        ...
        <div className="px-6 py-6 space-y-7">
          ...
          <div>
            ...
            <button
              onClick={saveNotes}
              disabled={saving}
              className="mt-2 text-[11px] uppercase tracking-[0.2em] font-sans font-semibold text-black bg-gradient-to-r from-mustard-500 to-mustard-400 rounded-lg px-5 py-2.5 disabled:opacity-50 hover:shadow-[0_0_20px_rgba(200,164,21,0.2)] transition-all"
            >
