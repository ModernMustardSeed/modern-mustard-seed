  ...
  return (
    <div className="min-h-screen bg-[#FBF6EA] text-[#161616]">
      ...
      <main className="max-w-7xl mx-auto px-5 md:px-6 py-8">
        ...
        {/* ── The build: mint a suite for a business you know ── */}
        <section className="bg-[#161616] border-2 border-[#161616] rounded-2xl shadow-[5px_5px_0_0_#F5B700] overflow-hidden mb-6">
          <div className="p-6 md:p-7 grid md:grid-cols-[1fr_auto] gap-6 items-center">
            <div className="min-w-0">
              <span className="text-[10px] uppercase tracking-[0.35em] text-[#F5B700] font-mono font-bold block mb-2">Build under your flag</span>
              ...
              <p className="mt-2 text-[#FBF6EA]/70 font-body text-sm leading-relaxed max-w-xl">
                Two minutes mints their whole suite: voice agent, website, hub. The lead lands on the dial floor prebuilt and your code rides the checkout.
              </p>
            </div>
            <Link
              href="/admin/hq/build"
