...
import { aiNativeTiers, aiNativeUsd, type AiNativeTier } from '@/data/ai-native';
  ...
  return (
    ...
    >
      ...
      <p className="mt-3 flex items-baseline gap-1.5">
        <span className="font-display text-4xl font-black tracking-tight text-[#161616]">{aiNativeUsd(tier.priceCents)}</span>
