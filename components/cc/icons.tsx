...
const PATHS = {
  ...
  week: (
    <>
      <P d="M4 5h12v11.5H4z" />
      <P d="M4 8.5h12M7 3.5V6M13 3.5V6" />
      <P d="M7 12h2M11 12h2" />
    </>
  ),
  note: (
    <>
      <P d="M4.5 3.5h11v9l-4 4h-7z" />
      <P d="M11.5 16.5v-4h4M7 7h6M7 9.5h4" />
    </>
  ),
  hand: (
    <>
      <P d="M3.5 8h10M11 5l3 3-3 3" />
      <P d="M16.5 12.5h-10M9 9.5l-3 3 3 3" />
    </>
  ),
  more: <P d="M4.5 10h.01M10 10h.01M15.5 10h.01" />,
  send: <P d="M16.5 3.5 9 11m7.5-7.5-4.8 13-2.7-5.5L3.5 8.3z" />,
  spark: (
    <>
