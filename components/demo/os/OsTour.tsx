...
export default function OsTour({ onGoTo, onClose }: { onGoTo: (tab: string) => void; onClose: () => void }) {
  ...
  const STEPS: TourStep[] = [
    { tab: 'today', eyebrow: 'Welcome', title: `This is ${possessive(config.business)} command center`, body: `Everything it takes to run the business, in one place. It comes free with your website or voice agent. Take 30 seconds${first} and I will show you what lives where.` },
