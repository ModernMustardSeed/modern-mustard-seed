...
const disciplines = [
  ...
  { title: 'Voice & Agentic Systems', href: '/voice-agents', text: 'Intelligence with a real job to do. Answer the call, book the work, and keep the operation moving long after the office closes.', tags: 'Voice agents · Automations · Agentic systems' },
  ...
  { title: 'Advisory', href: '/advisory', text: 'A clear-eyed technical partner for your next move. Decide what deserves to be built, what to simplify, and where agentic systems belong.', tags: 'Direction · Architecture · Ongoing counsel' },
];
...
export default function StudioHome({ faq, hero }: { faq: { q: string; a: string }[]; hero?: ReactNode }) {
  return <div className={styles.studio} data-design="mms-editorial-2026" data-edition="pop-art-studio">
    ...
    <section className={styles.proofStrip} aria-label="Studio proof points">
      ...
      <div className={styles.proofCards}>
        ...
        <div className={styles.proofCard + " " + styles.aiCard}><span className={styles.aiMark}>ANSWER ENGINES</span><strong>ChatGPT-ready studio</strong><small>Built to be found by ChatGPT and Google</small><span className={styles.aiBurst} aria-hidden="true">✳</span></div>
      </div>
