...
- **Models:** Anthropic Claude or OpenAI, depending on the workload
...
Days 18-19: Third-party integrations the product depends on. Resend for transactional email, the model provider, any webhooks. Each integration is a half-day if you do it now and a full day if you do it later.
...
We do this in 30 days flat, and we are booking new builds. [Book a free call](/book) and Sarah will reply fast, usually the same day, with a fit-check and a fixed quote.

If you want to ship it yourself, this is the whole playbook. Ping me on [X](https://x.com/modmustardseed) when yours is live.
