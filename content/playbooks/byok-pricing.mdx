...
description: "Three pricing models for agentic products, with the rule for picking the right one. Lessons from running BYOK plus metered credits at Make Me Studio."
date: "2026-05-05"
...
If you are charging for an agentic product, you have three pricing models to choose from. Picking wrong is the single biggest reason early agentic products stall.
...
Most teams pick subscription because it is familiar from SaaS. For agentic products, that is often the wrong call.

## Why subscription is dangerous for agentic products
...
For SaaS, the marginal cost of a user is near zero. For agentic products, the marginal cost is real and scales with engagement. The economics are different. The pricing model needs to match.
...
- Your customer is technical or fluent with the models.
...
Most production agentic products end up running two of the three at once. The most common combo:
...
For any agentic product, ask:

1. **What is my unit cost per active user per month?** If you cannot answer in one number, you are not ready to price.
2. **What is the gross margin I need?** Agentic products should target 60 to 80 percent gross margin.
...
Pricing too low. Every agentic product I have built was underpriced on day one. The fix was always painful. New customers at the higher price. Grandfathered legacy at the lower price. Annoying email to send.
