---
title: "Make Me Studio: A Creator's Generative Studio with BYOK and Stripe"
description: "A generative creative studio for video, image, and asset generation. BYOK, Stripe-metered, shipped to production with auth and usage tracking in five weeks."
date: "2026-03-15"
...
Creators who use generation tools want the power of pro-grade models without the SaaS lock-in. The premise of Make Me Studio: a single canvas with access to a curated set of generation models, paid through Stripe, with a "bring your own key" option for power users.

## What we shipped

- Multi-model generation (image, video, audio, copy)
