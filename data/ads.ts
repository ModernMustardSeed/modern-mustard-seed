...
export const BROADCAST = {
  ...
  metaTitle: 'Commercial Production and Ad Management',
  metaDescription:
    'Done-for-you advertising for local businesses: a cinematic commercial produced for your business, Facebook, Instagram, and Google ads launched and managed weekly, plain-English monthly reports. A set package price, quoted privately, month to month. By Modern Mustard Seed.',
