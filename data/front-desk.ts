...
export const frontDeskIntents: FrontDeskIntent[] = [
  {
    ...
    reply:
      "Seed received. A 24/7 voice agent on your own number: books appointments, answers your FAQs in a natural human voice, routes the urgent calls to you. Speaks 100+ languages. Fastest way to believe it: forge a free demo trained on YOUR business at modernmustardseed.com/voice-agents/forge and talk to it in sixty seconds. Want it built, or want to learn to build it yourself?",
