...
export type Industry = {
  ...
  /**
   * The free build this industry is sent to. Added 2026-07-20: these six pages
   * had no path into either build, so every visitor exited to /audit or a
   ...
   *
   * The Voice Agent Build was parked 2026-08-12 (Sarah); the missed-call route
   * pointed there and now points at /voice-agents. See Navbar.tsx.
   */
  build: { href: '/voice-agents' | '/demos'; label: string; blurb: string };
};

/** Copy for the two build destinations, so no page invents its own promise. */
...
export const industries: Industry[] = [
  // 1. Real Estate Investors
  {
    ...
    builds: [
      ...
      },
      {
        ...
        body:
          'An agent that scans expired listings, FSBO sources, divorce filings, probate records, and tax delinquency lists for properties that match your buy-box. Sends qualified leads to a single inbox or a CRM webhook. Replaces a virtual assistant for sourcing, runs 24/7, never asks for vacation.',
      },
      {
    ...
    faqs: [
      {
        q: 'What kind of agentic tools work best for real estate investors?',
        a: 'The four highest-leverage agentic tools for active investors are: (1) a deal analyzer that pulls comps and outputs a buy decision in under two minutes, (2) virtual staging that turns empty flips into MLS-ready listings without paying a stager, (3) an off-market sourcing agent that scans expired listings, FSBO sources, and public records for fit, and (4) a voice agent that qualifies and books seller leads 24/7. These four cover the entire investor workflow from acquisition to disposition. The tools that fail are generic chatbots and one-size-fits-all "investor CRMs" that do not understand your buy-box.',
      },
      {
        q: 'How much does it cost to build a custom deal analyzer?',
        a: 'A production-grade agentic deal analyzer like the PTG build is scoped to the data sources you want connected (RentCast, ATTOM, MLS, Zillow scraping) and the depth of the underwriting model. Shipping timeline is two to four weeks from kickoff. You own the code, the database, and the prompts when it is done. There is no SaaS subscription on the underlying tool because you are not renting it. Most investors recoup the build cost on the first deal it surfaces or saves.',
      },
      {
        q: 'How is this different from DealCheck, PropStream, or Privy?',
        a: 'DealCheck and PropStream are off-the-shelf tools built for the average investor. They cap at the analysis their UI supports. A custom agentic deal analyzer is shaped to your exact buy-box: your rehab cost assumptions per market, your preferred rent comps source, your specific ROI thresholds, and your reporting style. You are not paying $50 a month forever and praying they add the feature you need. You own the tool. You change it when your strategy changes. Most active investors who run more than five deals a quarter outgrow off-the-shelf tools within a year.',
      },
      {
        q: 'Can the analyzer handle BRRRR, fix-and-flip, and long-term rental analysis?',
      ...
      },
      {
        ...
        a: 'A few weeks from kickoff to a live, working deal analyzer. Week one is scope and data source connections. Week two is the underwriting model and the agentic reasoning layer. Week three is the front-end and the report output. Week four is iteration, edge cases, and your specific market assumptions. You see weekly demos and can request changes mid-build. We do not stop until the underwriting matches what you would do manually.',
      },
      {
  ...
  // 2. Realtors / Real Estate Agents
  {
    ...
    shortName: 'Realtors',
    metaTitle: 'Agentic Tools for Realtors and Real Estate Agents. Win the Next Five Years.',
    metaDescription:
      'Virtual staging, listing description generators, voice agents for buyer follow-up. Custom agentic tools for real estate agents who refuse to lose listings to better-equipped competition. Built in weeks, not months.',
    eyebrow: 'Agentic Systems for Real Estate Agents',
    h1: 'Agentic Tools for Realtors. Stop Losing Listings to Better-Equipped Competition',
    lede:
      'Real estate agents are getting squeezed from two directions. Buyers research listings on ChatGPT and Zillow before they ever call you. Sellers test FSBO tools that promise to save the 3% commission with automated listing, pricing, and contract workflows. The agents who win the next five years are the ones who fight back with the same tools, used better. We build the agentic tools that make your listings convert faster: virtual staging that finishes in under a minute, listing descriptions that read like a $400-an-hour copywriter wrote them, and voice agents that follow up with warm buyers 24/7. Real production tools, owned by you, shipped in weeks, not months.',
    ...
    faqs: [
      ...
      {
        q: 'How much does a custom agentic tool cost compared to monthly software?',
        a: 'A custom agentic tool is a one-time build you own. Brokerage software adds up to $3,000 to $7,000 per year depending on the stack. The break-even on a custom build is usually under two years, and at the end you own the tool instead of renting it. The bigger win is that the custom tool is yours: branded to your business, tuned to your market, and changed when your strategy changes.',
      },
      {
        q: 'Will this work for luxury listings?',
        a: 'Yes, with a caveat. Virtual staging is rarely used on luxury homes because luxury buyers tour in person and the photography is already premium. But model-written listing descriptions, voice agents for buyer follow-up, and comp comparison tools all work in luxury. The volume is lower, the stakes are higher, and the time saved per deal is more valuable. Several of our luxury clients use the agentic tooling specifically because their assistant is overloaded, not understaffed.',
      },
    ],
    cta: {
      headline: 'Fight back with better tools',
      body:
        'Run the free Bottleneck Breaker. We will tell you which agentic tool would protect your listings, your time, and your commission split the fastest.',
    },
  },
  ...
  // 3. Service Businesses
  {
    ...
    metaTitle: 'Agentic Systems for Service Businesses. Voice Agents and Automation, Built Custom.',
    metaDescription:
      'voice agents that answer 24/7, qualify leads, and book appointments. Custom agentic tools for plumbers, HVAC, cleaning, med spas, and contractors. Shipped in weeks, not months.',
    eyebrow: 'Agentic Systems for Service Businesses',
    h1: 'Agentic Systems for Service Businesses. Stop Missing the Calls That Pay the Bills',
    lede:
    ...
    builds: [
      ...
      },
      {
        ...
        body:
          'For owners running multiple techs, an agentic scheduling layer that matches incoming jobs to the best-fit tech based on location, skillset, and existing route. Reduces drive time, increases jobs-per-day, and stops the dispatch chaos that eats your Saturday.',
      },
    ],
    receipt: {
      caseStudySlug: 'voicestaff',
    ...
    faqs: [
      {
        q: 'Does a voice agent actually sound human on the phone?',
        a: 'Yes. A modern voice agent on Vapi or similar platforms sounds indistinguishable from a human receptionist for the first 90 seconds of any call. The voice has natural pauses, handles interruptions, recovers from mid-sentence corrections, and uses your brand voice. The caller almost never realizes they are talking to a voice agent unless the conversation goes deeply off-script. Most service-business calls are 60 to 90 seconds, exactly the window where a voice agent is strongest.',
      },
      {
        q: 'What happens when a caller asks something the agent does not know?',
        a: 'Two options, chosen at build time. Option one: the agent takes a message, confirms the callback time, and routes the lead to your inbox with a transcript. Option two: the agent transfers the call to your cell during business hours, or to voicemail with priority routing after hours. Most service businesses use option one for routine calls and option two for emergencies. The decision tree is built into the agent during week two of the engagement.',
      },
      {
        q: 'Can the agent book onto my calendar?',
  ...
  {
    slug: 'dtc-brands',
    build: BUILD_CTA.demos,
    name: 'DTC and Apparel Brands',
    shortName: 'DTC Brands',
    metaTitle: 'Agentic Systems for DTC and Apparel Brands. Sketch to Shipped Drop, Faster.',
    metaDescription:
      'Custom agentic design studios, headless storefronts, generated product photography. Apparel and DTC builds shipped in weeks, not months. From sketch to live storefront in under 60.',
    eyebrow: 'Agentic Systems for DTC and Apparel',
    h1: 'Agentic Systems for Apparel and DTC Brands. From Sketch to Shipped Drop, Faster',
    lede:
      'Running a DTC brand in 2026 means competing with brands that ship a drop every two weeks and run agentic systems on every touchpoint of the customer journey. The good news is you can do the same thing without hiring a team. We built Cross + Covenant from sketch to live storefront in under 60 days using a custom agentic design pipeline, a headless Shopify storefront, and a two-tier production model with Printify and Apliiq. The same pattern works for any apparel brand willing to let agentic systems do the heavy lifting on design exploration, product photography, listing copy, and email sequences. You own the brand. The system accelerates everything around it.',
    ...
    builds: [
      ...
      {
        title: 'Generated Product Photography',
        body:
          'On-model shots and flatlays generated from a single design file. Eight aesthetic styles, multiple poses, background variations. Replaces a $2,000 photoshoot per drop with a sub-$100 per-drop render workflow. Photos look real, perform on ads, and ship same-day.',
      },
      {
      ...
      {
        title: 'Generated Listing Copy and Email Sequences',
        body:
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Sixty days from kickoff to a live storefront taking real orders. Week one is brand discovery and product strategy. Weeks two and three are the front-end build. Week four is the agentic design studio (if included in scope). Week five is payments, fulfillment, and QA. Week six is launch prep and the first drop. You own the domain, the Shopify account, and the agentic tooling from day one.',
      },
      {
        q: 'Do I own the code and the prompts?',
        a: 'Yes. Every line of code, every prompt template, the Shopify account, the Supabase project, and every credential is transferred to you on day one. We do not host your store. You own it. Most brands keep us on a small retainer for ongoing iteration, but that is optional. You can hand the codebase to any other engineer the day after launch.',
      },
      {
  ...
  // 5. Solopreneurs and Creators
  {
    ...
    metaTitle: 'Agentic Systems for Solopreneurs and Creators. The OS You Should Have Built Years Ago.',
    metaDescription:
      'Custom solo operating systems, personal brand sites, agentic content engines, intentional capture apps. For solopreneurs who refuse to live inside 47 SaaS subscriptions.',
    eyebrow: 'Agentic Systems for Solopreneurs',
    h1: 'Agentic Systems for Solopreneurs. The OS You Should Have Built Two Years Ago',
    lede:
    ...
    builds: [
      ...
      {
        title: 'Agentic Content Engine',
        caseStudySlug: 'make-me-studio',
        body:
          'A creator studio for generated video, image, and asset work. BYOK on the model providers (Anthropic, OpenAI, Gemini, Replicate). Stripe-metered if you want to license access to your team or community. Built for creators who are also operators.',
      },
      {
        title: 'Intentional Capture App',
        caseStudySlug: 'alive-notes',
        body:
          'A mobile-first capture app for notes, voice memos, ideas, and intentions that actually act on what you capture. Built with Expo and React Native. Beautifully crafted, agent-aware, and shaped to how a working creator actually thinks.',
      },
      {
      ...
      },
      {
        ...
        body:
          'A simple lead pipeline tuned for solo operators: a single inbox, agent-drafted replies, automated follow-up sequences, and analytics that tell you which conversations move money. No 14-stage enterprise CRM. Just enough structure to stop losing warm leads.',
      },
    ],
    receipt: {
      caseStudySlug: 'olive-shoot',
    ...
    pricing: {
      typicalRange: 'Quoted after a free Bottleneck Breaker',
      body:
        'A personal brand site plus newsletter pipeline is the entry point. A focused agentic content engine or capture app is a step up. A full custom solo OS like Olive Shoot is the largest build, scaling with integrations and the depth of the agentic logic. The free Bottleneck Breaker is the right place to start. We will tell you in 60 minutes which build would give you the most leverage on the time you actually have, what it would cost, and how fast we can ship it.',
    },
    faqs: [
      {
      ...
      {
        q: 'How do agentic systems actually fit in?',
        a: 'Agentic systems in a solo OS show up in four specific places: (1) email and outreach drafting that sounds like you, (2) content repurposing from one source asset into multiple platform formats, (3) lead qualification and follow-up sequence selection, and (4) summary and digest generation across your projects so you can see the state of the business in 60 seconds. The agents are a layer, not the centerpiece. The OS still works if you turn the agents off.',
      },
      {
  ...
  // 6. Coaches and Consultants
  {
    ...
    builds: [
      ...
      },
      {
        ...
        caseStudySlug: 'make-me-studio',
        body:
          'A creator-style agentic engine tuned for consultant content: turn one 30-minute voice memo into a week of LinkedIn posts, a newsletter draft, a short video script, and a sales asset. Brand-voiced. On-tone. Edited by you, not generated for you. Pattern proven on Make Me Studio.',
      },
      {
        title: 'Agentic Proposal Generator',
        body:
    ...
    receipt: {
      caseStudySlug: 'make-me-studio',
      caseStudyTitle: 'Make Me Studio: A Creator\'s Agentic Studio with BYOK and Stripe',
      headline: 'A content engine you actually use',
      body:
        'Make Me Studio is a creator-style agentic studio for video, image, and asset generation. The pattern is exactly what coaches and consultants need: BYOK on the model providers so you control the spend and the model selection, Stripe-metered usage if you want to license access to a team or community, and a clean output workflow that produces brand-voiced assets instead of generic machine slop. Stack: Next.js 15, Supabase for auth and project storage, Stripe for metered billing, Google Gemini and OpenAI for the generation, Vercel for deploy. Shipped to production with auth and usage tracking in five weeks. For a coach or consultant, the same architecture turns one 30-minute voice memo into a week of LinkedIn posts, a newsletter draft, three short videos scripts, and a sales asset. You stop dreading content week. You start treating content as exhaust from the work you were already doing.',
      metrics: [
    ...
    pricing: {
      typicalRange: 'Quoted after a free Bottleneck Breaker',
      body:
        'A single-purpose agentic tool like an intake bot or proposal generator is the entry point. A custom content engine is a step up. A full consultant OS that combines intake, content, proposals, and a follow-up voice agent is the largest build. Start with the free Bottleneck Breaker. We will tell you in 60 minutes which task in your week is bleeding the most hours, what to automate first, and what the payback period looks like. Most consultants recover the build cost inside the first quarter from reclaimed calendar time alone.',
    },
    faqs: [
      {
        q: 'Will agentic systems replace my coaching or consulting?',
        a: 'No. An agentic system cannot replicate the relationship, the judgment, or the accountability that drives a coaching or consulting engagement. What it can replace is the 15 hours a week you spend on intake, follow-up, content production, proposal writing, and admin. That is the time agentic systems were built for. The hour you spend with a client is still the hour your client pays for, and that hour does not change.',
      },
      {
