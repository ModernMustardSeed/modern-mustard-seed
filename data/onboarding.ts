...
export const OFFER_LADDER: LadderRung[] = [
  ...
  },
  {
    ...
    examples: ['Pictures commercial ($197 / $497)', 'Voice Agent ($297 setup + $297/mo)', 'GEO Fix Pack ($297)'],
  },
  {
    rung: 4,
    band: 'Learn to build',
    ...
    modules: [
      ...
      },
      {
        ...
        blocks: [
          ...
          {
            callout:
              'Every email this company sends closes the same way: Sarah\'s name, and a phone number a real person answers. That sign-off is the promise behind all of it, and now you carry it too. You are not being onboarded to a company. You are being written into it.',
          },
        ],
...
export const GLOSSARY: GlossaryTerm[] = [
  ...
  { term: 'Setup fee', def: 'A one-time charge to stand up a product (like the $297 to set up a Voice Agent), often credited toward a bigger build.' },
