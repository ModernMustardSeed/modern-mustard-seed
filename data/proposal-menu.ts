...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    scope: [
      'Every domain transferred, with the registry fee and the year it adds included',
      'Hosting moved off the old provider, with the website and the email untouched while it happens',
      'DNS held here, so a change takes minutes instead of a support ticket',
      'Renewals carried by us and re-read from the registry every week, so nothing lapses quietly',
      'Every name visible in your Command Center, with who holds it and when it renews',
      'Transferred into an account of your own on a day’s notice, whenever you ask',
    ],
    priceMin: 497,
    priceMax: 497,
    unit: 'fixed',
  ...
  },
  {
    ...
    scope: [
      'Its own address and its own sign-in, separate from the project portal',
      'Leads, with who is still waiting on a call, and the whole story behind each one',
      'Your mailbox read twice an hour, sorted, with a reply drafted where one is needed',
      'Every conversation your website had, in the visitor’s own words',
      'Your contact book, searchable, yours to export any time',
      'Reviews asked the day a job closes, with a record so nobody is asked twice',
      'Wired into Buildertrend, your Google profile and your feeds',
      'An operator that drafts, asks, marks and makes, and shows what it actually did',
    ],
    priceMin: 497,
    priceMax: 497,
    unit: 'fixed',
  ...
  },
  {
    ...
    scope: [
      'Mail read and sorted twice an hour, with drafts written in your voice',
      'Leads captured from every door and handed to your pipeline',
      'Domains re-read weekly and renewals carried',
      'The operator kept current with your accounts and your data',
      'Changes to what we built are included, always',
    ],
    priceMin: 197,
    priceMax: 197,
    unit: 'monthly',
