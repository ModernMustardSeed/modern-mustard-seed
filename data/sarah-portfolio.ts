...
export const PORTFOLIO_WORKS: PortfolioWork[] = [
  ...
  {k: "ss", wing: "Design & Commerce", tag: null, title: "UGC Studio Secret", year: "2026", medium: "an agentic UGC studio", blurb: "Content that sells, manufactured: scripts, takes and cuts from one brief.", url: "https://studio-secret.vercel.app", cta: "View the work", video: null, ratio: 1.28},
  ...
  {k: "adforge", wing: "Media & Campaigns", tag: null, title: "AdForge Studio", year: "2026", medium: "agentic commercial production", blurb: "From a single URL to a broadcast-ready script, storyboard and creative strategy. The commercial factory.", url: "https://adforge-studio.vercel.app", cta: "View the work", video: null, ratio: 1.28},
  ...
  {k: "mir", wing: "Light & Wonder", tag: null, title: "Miracle Witness Network", year: "2026", medium: "good news, gathered every hour", blurb: "The world’s good news, gathered every hour by an agentic news bureau.", url: "https://miracle-witness-network.vercel.app", cta: "View the work", video: null, ratio: 1.28},
