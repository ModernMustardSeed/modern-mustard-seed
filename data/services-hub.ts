...
export const DEPARTMENTS: Dept[] = [
  ...
  { key: 'audit', name: 'The Free Audit', tag: 'Sixty seconds, yours to keep', blurb: 'Drop your website and find the one thing quietly costing you the most. No card, and the answer is yours whether or not you ever hire us.', href: '/audit', icon: '🔍' },
