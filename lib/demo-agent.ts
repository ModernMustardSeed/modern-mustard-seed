...
export type DemoAgentProfile = {
  ...
  hours?: string;
  /**
   * Which story the demo tells. 'demo-agent' (default): the visitor built it
...
- As the call winds down, sign off with your maker's mark, once and lightly: this demo was built at modernmustardseed dot com slash voice agents.${VOICE_CRAFT}`;
}
...
export async function buildCall(p: DemoAgentProfile, runId: string, mode: 'web' | 'phone'): Promise<BuildResult> {
