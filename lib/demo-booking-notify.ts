 ...
 * that a forged demo call arrives as "Mr. Mustard call summary · Web call",
 ...
 *
 * Self-serve forges (somebody who built their own on /voice-agents/forge) have
      ...
      html: clientEmail({
        ...
        body:
          ...
          (lead
            ...
            : `<p>This one forged their own demo, so there is no lead row behind it. The booking is on the demo either way.</p>`) +
