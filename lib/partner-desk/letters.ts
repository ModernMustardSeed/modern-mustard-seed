...
export function partnerMath() {
  ...
  return {
    ...
    talkingWebsite: { name: DEMO_BUNDLE.name, monthly: DEMO_BUNDLE.monthlyCents, setup: DEMO_BUNDLE.setupCents, perMonth: tw, year: tw * months },
...
function offer(): string[] {
  ...
  return [
    ...
    `- Ten kept ${m.talkingWebsite.name}s is ${dollars(m.tenTalkingWebsites.perMonth)} a month to you for a year.`,
