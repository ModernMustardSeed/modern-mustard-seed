...
export const CLOSING_BAND_RULE = `THE CLOSING BAND (hard law, 2026-08-21; Sarah, on a live demo: "the bottom of the page where booking and footer is, kinda drags. make it way more artistic and beautiful")
...
Rules: it uses their REAL harvested photography or generated frames, never drawn art; it works on touch as a drag and on desktop as a drag or hover; it degrades to a static image with no JS; it never blocks scroll; and it is ONE moment, placed where the story wants it, not a page of gimmicks. If the trade offers nothing worth this, ship no signature moment rather than a generic carousel.`;
