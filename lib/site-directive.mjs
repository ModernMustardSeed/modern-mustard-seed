...
COPY RULES
- Confident, specific, warm; short sentences; write like the best copywriter in their trade. Use ONLY facts from the brief or harvested from their own materials: never invent testimonials, review counts, star ratings, years in business, certifications, staff names, or prices. Sampled proof exists ONLY inside the Proof Wall's sample state, under its caption, never anywhere else on the page. No em dashes anywhere. No word "cheap".`;
