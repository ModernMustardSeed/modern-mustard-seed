 ...
 */
export const PROGRESS_SLIDER_RULE = `THE PROGRESS SLIDER (MANDATORY for roofing, construction, general contracting, remodeling, home builders, and residential developers; it REPLACES the static hero photograph for those trades)
...
- WHAT THE PAIR IS, by trade: home builder, developer, or general contractor gets FRAMING (bare studs, plywood sheathing, mud lot, silt fence, flat overcast light) to FINISHED (roof, siding, glowing windows, mature landscaping, and warm landscape uplighting at blue-hour dusk, the lighting complementing the house). Roofing gets a stripped or storm-damaged deck to a finished roof. Remodeling gets a gutted room to the finished room. Landscaping gets a bare yard to a planted one. Painting gets chalked and peeling to fresh. Match the light deliberately: the raw frame is flat and grey, the finished frame is warm and lit, so the drag feels like time passing rather than two photos swapping.
