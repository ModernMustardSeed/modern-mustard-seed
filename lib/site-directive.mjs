...
- Only if they gave us NO usable photos, generate ONE photorealistic hero with fal.ai (${falEnv}; pipeline notes: ${mediaNotes}). If that fails, retry, then pull a matching real frame from C:/Users/moder/mms-demo-sites/_library/index.json. NEVER inline SVG scene art. Never a stock-photo look.
