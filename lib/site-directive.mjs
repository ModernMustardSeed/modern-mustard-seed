...
- FONTSHARE IS ALLOWED AND ENCOURAGED alongside Google Fonts (api.fontshare.com, free for commercial use, same non-blocking load pattern as the font link rule below). Clash Display, General Sans, Satoshi and Cabinet Grotesk are the fastest way off the Google default look, because every competitor on the street is using the Google top twenty.
