 ...
 *
 * Local (CLI) builds only. The serverless failsafe has no Codex login, so
 * apiDirective keeps painting heroes with fal.
 */
export const IMAGE_TOOL = String.raw`HOW TO GENERATE AN IMAGE (free, on the Codex subscription; use this FIRST, every time):
  node C:/Users/moder/.claude/tools/codex-image.mjs --prompt "<your full art direction>" --out hero.jpg --width 1600 --height 900 --json
...
- C:/Users/moder/modern-mustard-forge/plugins/award-site-forge/skills/forge-award-site/SKILL.md
- C:/Users/moder/modern-mustard-forge/plugins/award-site-forge/skills/forge-award-site/references/experience-spec.md
...
THE DESIGN SYSTEM. Read both files COMPLETELY before designing, and follow them as law:
- C:/Users/moder/wildmere/TEMPLATE.md (the anatomy, the parameter knobs, THE TEN LAWS)
- C:/Users/moder/wildmere/VARIANTS.md (ten art directions, three hero composition modes, the selection doctrine)
...
${IMAGE_TOOL}
(fal fallback key: ${falEnv}; pipeline notes: ${mediaNotes}.) READ every generated asset before building around it. NO UNTOUCHED SQUARES (Sarah 2026-07-30): EVERY visual slot carries photography. Every offer card, chapter plate, gallery tile, and image square gets a real or generated photograph graded into the page's light story; a text-only tile where the design shows an image slot is a FAILED build. BiRefNet (fal-ai/birefnet/v2) for photo cutouts. Footage loops only if the final asset stays under 300KB; chroma-key footage per frame in JS, NEVER mix-blend-mode for footage. Their harvested real photos are proof and go in at gallery scale. If generation fails after a retry, reuse a matching real photograph from C:/Users/moder/mms-demo-sites/_library/index.json and regrade it. PHOTOS.md in this directory means REUSE those photographs, do not regenerate.
...
- THE PHONE IS THE CLOSE. The lead's real phone from BRIEF.md rides every primary CTA as a tel: link. The booking form is an in-page sheet reaching an honest "Requested, they will text to confirm" state plus the tel line; never a false confirmation.
...
- C:/Users/moder/modern-mustard-seed/docs/tier3-journey/TEMPLATE.md (the anatomy, the journey metaphors, the cinema rules)
...
${IMAGE_TOOL}
(fal fallback key: ${falEnv}; pipeline notes: ${mediaNotes}.) If that fails, retry, then pull a matching real frame from C:/Users/moder/mms-demo-sites/_library/index.json. NEVER inline SVG scene art. Never a stock-photo look.
