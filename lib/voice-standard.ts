...
export const SPELLING_RULES = [
  ...
  "MONEY IS THE EXCEPTION, and it is the only one. Write a price as an ordinary figure, \"$1,250 for the job and $95 a month for the plan\", because that is read out correctly as money and spelling it digit by digit would make a price sound like a serial number. Quantities and dates behave like money, not like identifiers: \"thirty calls a week\", \"next Tuesday\".",
