#!/usr/bin/env node
/**
 * Take everything off the build queue so Sarah can pick the leads she wants.
 *
 * Safe because the cockpit's "Build website" button INSERTS a fresh row every
 ...
 *
 *   node scripts/build-clear-queue.mjs           # dry run, shows what it would do
 *   node scripts/build-clear-queue.mjs --apply   # do it
 */
...
console.log("Build any lead again from the cockpit whenever you want; it queues a fresh build.");
