#!/usr/bin/env node
/**
 * Put sites back from a .forge-backups snapshot.
 *
 ...
 *
 *   node scripts/forge-restore.mjs <prefix>            # dry run
 *   node scripts/forge-restore.mjs <prefix> --apply
 *
...
if (!prefix) { console.error('usage: forge-restore.mjs <prefix> [--apply]'); process.exit(1); }
