    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          build: {
            type: 'array',
            items: { type: 'string', enum: ['voice_agent', 'website'] },
            description:
              "REQUIRED. Only the pieces they said they want, from what you learned asking. 'voice_agent' = the agent that answers their phone. 'website' = a custom site built from scratch. Those are the only two things that can be forged; the command center is hand built and is NOT available here. Pass one when they want one. NEVER add a piece they did not ask for: building a website for someone who only wanted their phone answered wastes the day's build capacity and contradicts the price you quoted.",
          },
