...
Six engraved "film still" plates, generated by Sarah in Codex (free) instead of
fal. The render script works without them (typographic laurel layout) and
upgrades automatically when a plate exists at `art/<key>.png`.
